...
var oDelivery;
var oDetails;
return Controller.extend("claims.Entrego.view.myOrderBid", {
onInit: function(){
  var that = this;
  ...
  that.getView().setModel(this.oModel,"oModel");
    ...
    onloadData: async function(){
      this.oModel.getData().DataRecords = await APPui5.ExecQuery("getMyBid","Array",localStorage.getItem("RFIDuserName"),"","","",false);
      this.oModel.refresh();
    },
